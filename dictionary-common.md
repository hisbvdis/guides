...
### Pure function
**Чистые функции** — не обладают побочными эффектами за пределами функции;  не изменяют входящие данные;  лишь обрабатывают входящие через аргументы данные и возвращают результат в виде значения или функции

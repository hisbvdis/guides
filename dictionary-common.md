...
**Вспомогате#льные технологии** — средства, помогающие людям с ограниченными возможностями в повседневной жизни *(например, скринридер/экранный диктор)*
...
### Bug
**Ошибка** — ошибка в программе, из-за которой программа себя неожиданно ведёт, выдает неправильный результат, либо не выполняется вообще

### Bundle
**Пакет** — файл, объединяющий данные по определённому признаку
...
### Swip
**Свайп** — смахивающий жест, при котором пользователь касается экрана и проводит пальцем в определённом направлении с целью вызвать определённое поведение
